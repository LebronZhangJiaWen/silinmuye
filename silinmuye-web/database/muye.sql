...
CREATE TABLE `tbl_company` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `strTitle` varchar(50) DEFAULT NULL COMMENT '公司名称',
  `strContent` text COMMENT '公司描述',
  `strManger` varchar(20) DEFAULT NULL,
  `strMangerName` varchar(20) DEFAULT NULL,
  `strMobile` varchar(11) DEFAULT NULL,
  `strErWerUrl` varchar(1000) DEFAULT NULL COMMENT '二维码图片地址',
  `strLongitude` varchar(20) CHARACTER SET latin1 DEFAULT NULL COMMENT '经度',
  `strLatitude` varchar(20) CHARACTER SET latin1 DEFAULT NULL COMMENT '纬度',
  `strAddress` varchar(255) DEFAULT NULL,
  `strEmail` varchar(20) DEFAULT NULL,
  `strWechat` varchar(20) DEFAULT NULL,
  `strQQ` varchar(20) DEFAULT NULL,
  `nStatus` int(1) DEFAULT '1' COMMENT '启用状态1启用0停用',
  PRIMARY KEY (`id`)
...
ALTER TABLE `tbl_ads` ADD COLUMN `isHomeAd`  int(1) NOT NULL DEFAULT 0  COMMENT '0:不是主页轮播广告；1:主页轮播广告 ' AFTER `status`;
...
VALUES
  ...
  ('site_seo_title','又一个MUYE社区','SEO标题'),
  ('site_icp','京ICP备17067217号','备案号'),
...
INSERT INTO tbl_score_rule(id,create_time,update_time,name,score,remark,type,status) VALUES
  ...
  INSERT INTO `tbl_company` VALUES ('1', '河南省原阳县平原新区四林木业', '郑州桥北平原新区四林木质厂是河南省郑州市专业生产销售：出口专用木托盘、叉车叉盘、木栈板、垫仓板、卡板、木包装箱、等包装制品的企业之一。<br>\r\n                            产品长期销往郑州市（巩义、新郑、荥阳、中牟、新密、登封，上街）及省内的开封、许昌（长葛）、漯河、驻马店、洛阳、商丘、新乡、焦作、安阳、济源、鹤壁、濮阳、\r\n                            三门峡、平顶山、周口、信阳、南阳。及省外的湖北、陕西、江苏（徐州、连云港）、山东（荷泽、青岛）等地区。为格力等大型厂商提供过出口包装所用木质包装原材料。', '总经理', '张权利', '15136701889', '/res/front/images/erweima.jpg', '113.753456', '34.965715', '河南省原阳县韩董庄镇拾区桥北四林木场', '819126279@qq.com', '819126279', '819126279', '1');
