...
<head>
    ...
    <title>修改帖子 - ${SITE_NAME} - Powered By dingdingzhongyuan</title>
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-md-12 article-detail">
                <form class="form-horizontal muye_form" role="form" action="${basePath}/group/topicUpdate" method="post" onsubmit="ckUpdate();">
