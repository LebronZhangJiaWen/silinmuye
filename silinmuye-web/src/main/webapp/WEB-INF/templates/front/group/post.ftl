...
<head>
    ...
    <title>发帖 - ${group.name} - ${SITE_NAME} - Powered By dingdingzhongyuan</title>
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-md-12 article-detail">
                <form class="form-horizontal muye_form" role="form" action="${basePath}/group/post" method="post" onsubmit="ckUpdate();">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            ...
                            <a href="/article/list" class="btn btn-default muye-submit">取消</a>
                        </div>
                    </div>
                </form>
            </div>
