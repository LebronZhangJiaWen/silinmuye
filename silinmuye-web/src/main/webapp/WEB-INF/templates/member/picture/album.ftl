...
<head>
    ...
    <title>相册 - ${SITE_NAME} - Powered By dingdingzhongyuan</title>
            ...
            <div class="no-border">
                <div class="panel-heading">
                    ...
                    <span class="pull-right">
                        <a class="btn btn-primary m-t-n4" href="${basePath}/member/picture/addAlbum" target="_muyeOpen" height="360px">新建相册</a>
                    </span>
                </div>
