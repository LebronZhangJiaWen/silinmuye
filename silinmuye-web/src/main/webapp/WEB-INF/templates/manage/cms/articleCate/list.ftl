...
<head>
    ...
    <title>文章栏目管理 - ${SITE_NAME} - 定鼎中原网后台管理系统 - Powered By dingdingzhongyuan</title>
...
<#include "/manage/common/header.ftl"/>
    <div class="content-wrapper">
        <section class="content-header">
            <h4>
                <a href="${managePath}/cms/articleCate/add" target="_muyeOpen" title="添加栏目">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>${mainMenu.sort}</td>
                                    <td>
                                        <a href="${managePath}/cms/articleCate/edit/${mainMenu.id}" target="_muyeOpen"
                                           title="编辑栏目">
                                            <span class="label label-warning"><i class="fa fa-edit green"></i></span>
                                        </a>
                                        <a target="_muyeLink" href="${managePath}/cms/articleCate/delete/${mainMenu.id}"
