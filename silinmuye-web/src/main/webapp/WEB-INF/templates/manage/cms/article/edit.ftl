...
<head>
    ...
    <title>编辑文章 - ${SITE_NAME} - 定鼎中原网后台管理系统 - Powered By dingdingzhongyuan</title>
...
<div class="wrapper">
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal muye_form" role="form" action="${managePath}/cms/article/update" method="post" onsubmit="ckUpdate();">
