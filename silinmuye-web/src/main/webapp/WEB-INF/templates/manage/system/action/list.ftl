...
<head>
    ...
    <title>会员动态类型 - ${SITE_NAME} - 定鼎中原网后台管理系统 - Powered By dingdingzhongyuan</title>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if action.status=1>
                                            <a class="marg-l-5" target="_muyeLink" href="${managePath}/system/action/isenable/${action.id}">
                                    ...
                                    <td>
                                        <a href="${managePath}/system/action/edit/${action.id}" target="_muyeOpen" title="编辑动态类型" height="350px">
