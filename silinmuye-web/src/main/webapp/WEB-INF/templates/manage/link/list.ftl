...
<head>
    ...
    <title>友情链接管理 - ${SITE_NAME} - 定鼎中原网后台管理系统 - Powered By dingdingzhongyuan</title>
                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">
                                <a href="${managePath}/link/add" target="_muyeOpen"
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if link.status=0>
                                        <a class="marg-l-5" target="_muyeLink" href="${managePath}/link/enable/${link.id}" confirm="确定要启用友情链接吗？">
                                            <span class="label label-danger">禁用</span>
                                        </a>
                                        <#else>
                                        <a class="marg-l-5" target="_muyeLink" href="${managePath}/link/enable/${link.id}" confirm="确定要禁用友情链接吗？">
                                    ...
                                    <td>
                                        <a href="${managePath}/link/edit/${link.id}" target="_muyeOpen"
