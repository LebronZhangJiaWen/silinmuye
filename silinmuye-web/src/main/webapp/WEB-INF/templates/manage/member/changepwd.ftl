...
<head>
    ...
    <title>修改密码 - ${SITE_NAME} - 定鼎中原网后台管理系统 - Powered By dingdingzhongyuan</title>
...
<div class="wrapper">
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal muye_form" role="form" action="${managePath}/member/changepwd" method="post" onsubmit="return false;">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button type="submit" class="btn btn-info muye-submit">确定修改</button>
                        </div>
                    </div>
                </form>
            </div>
