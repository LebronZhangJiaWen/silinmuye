...
<head>
    ...
    <title>定鼎中原网后台管理系统登录 - ${SITE_NAME} - Powered By dingdingzhongyuan</title>
...
<div class='login'>
    ...
    <div class='disclaimer'>
        <p>欢迎登陆定鼎中原网后台管理系统 <a href="../">返回首页</a></p>
        <p>Powered By <a href="http://www.dingdingzhongyuan.com" target="_blank">dingdingzhongyuan</a> CopyRight © 2012-2017</p>
    </div>
</div>
<div class='authent'>
