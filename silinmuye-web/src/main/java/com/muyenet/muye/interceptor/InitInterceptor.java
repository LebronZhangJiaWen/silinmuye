...
import com.muyenet.muye.core.annotation.After;
import com.muyenet.muye.core.annotation.Before;
import com.muyenet.muye.core.annotation.Clear;
            ...
            if (handler.getClass().isAssignableFrom(HandlerMethod.class)) {
                ...
                for (int i = 0; i < annotationList.size(); i++) {
                    ...
                    if (before != null) {
                        ...
                        if (!hasClear) {
                            Class<? extends MuyeInterceptor> interceptorlll = before.value();
            ...
            if (handler.getClass().isAssignableFrom(HandlerMethod.class)) {
                ...
                for (int i = 0; i < annotationList.size(); i++) {
                    ...
                    if (after != null) {
                        ...
                        if (!hasClear) {
                            Class<? extends MuyeInterceptor> interceptorlll = after.value();
                            Object object = Class.forName(interceptorlll.getCanonicalName()).newInstance();
                            Class[] clazzs = new Class[]{HttpServletRequest.class, HttpServletResponse.class, Object.class};
                            Method method = object.getClass().getMethod("interceptor", clazzs);
