...
public class ArticleController extends BaseController {
    ...
    public String list(String key, @RequestParam(value = "cid",defaultValue = "0",required = false) Integer cid,
        ...
        return muyeConfig.getFrontTemplate() + "/cms/list";
    }
    ...
    public String detail(@PathVariable("id") Integer id, Model model){
        ...
        if(article == null || article.getStatus() == 0){
            return muyeConfig.getFrontTemplate() + ErrorUtil.error(model,-1009, Const.INDEX_ERROR_FTL_PATH);
        }
        //更新文章访问次数
        ...
        return muyeConfig.getFrontTemplate() + "/cms/detail";
    }
    ...
    public String add(Model model) {
        ...
        return muyeConfig.getFrontTemplate() + "/cms/add";
    }
    ...
    public String edit(@PathVariable("id") int id, Model model){
        ...
        model.addAttribute("cateList",cateList);
        model.addAttribute("loginUser", loginMember);
        return muyeConfig.getFrontTemplate() + "/cms/edit";
    }
