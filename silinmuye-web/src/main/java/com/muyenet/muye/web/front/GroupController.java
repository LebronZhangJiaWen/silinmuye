...
import com.muyenet.muye.core.utils.*;
...
public class GroupController extends BaseController {
    ...
    public String index(String key,Model model) {
        ...
        return muyeConfig.getFrontTemplate() + "/group/index";
    }
    ...
    public String apply(){
        ...
        return muyeConfig.getFrontTemplate() + "/group/apply";
    }
    ...
    public String detail(@PathVariable("groupId") Integer groupId, Model model) {
        ...
        if(group == null){
            return muyeConfig.getFrontTemplate() + ErrorUtil.error(model,-1002, Const.INDEX_ERROR_FTL_PATH);
        }
        ...
        return muyeConfig.getFrontTemplate() + "/group/detail";
    }
    ...
    public String edit(@PathVariable("groupId") Integer groupId,Model model){
        ...
        if(group.getCreator().intValue() != loginMember.getId().intValue()){
            return muyeConfig.getFrontTemplate() + ErrorUtil.error(model,-1001,Const.INDEX_ERROR_FTL_PATH);
        }
        model.addAttribute("group",group);
        String managerIds = group.getManagers();
        ...
        model.addAttribute("loginUser", loginMember);
        return muyeConfig.getFrontTemplate() + "/group/edit";
    }
    ...
    public String topic(@PathVariable("topicId") Integer topicId,Model model){
        ...
        if(groupTopic == null){
            return muyeConfig.getFrontTemplate() + ErrorUtil.error(model,-1004,Const.INDEX_ERROR_FTL_PATH);
        }
        ...
        if(group == null){
            return muyeConfig.getFrontTemplate() + ErrorUtil.error(model,-1000,Const.INDEX_ERROR_FTL_PATH);
        }
        String groupManagers = group.getManagers();
        String[] groupManagerArr = groupManagers.split(",");
        ...
        model.addAttribute("loginUser", loginMember);
        return muyeConfig.getFrontTemplate() + "/group/topic";
    }
    ...
    public String post(@PathVariable("groupId") Integer groupId,Model model){
        ...
        if(groupFans == null){
            return muyeConfig.getFrontTemplate() + ErrorUtil.error(model,-1003, Const.INDEX_ERROR_FTL_PATH);
        }
        if(group.getCanPost() == 0){
            return muyeConfig.getFrontTemplate() + ErrorUtil.error(model,-1006, Const.INDEX_ERROR_FTL_PATH);
        }
        model.addAttribute("group",group);
        return muyeConfig.getFrontTemplate() + "/group/post";
    }
    ...
    public String topicEdit(@PathVariable("topicId") Integer topicId,Model model){
        ...
        model.addAttribute("groupTopic",groupTopic);
        model.addAttribute("loginUser", loginMember);
        return muyeConfig.getFrontTemplate() + "/group/topicEdit";
    }
    ...
    public String auditList(@PathVariable("groupId") Integer groupId, Model model) {
        ...
        model.addAttribute("managerList",managerList);
        model.addAttribute("loginUser", loginMember);
        return muyeConfig.getFrontTemplate() + "/group/auditList";
    }
    ...
    public String fans(@PathVariable("groupId") Integer groupId, Model model) {
        ...
        model.addAttribute("model",responseModel);
        return muyeConfig.getFrontTemplate() + "/group/fans";
    }
