...
import com.muyenet.muye.core.exception.NotLoginException;
import com.muyenet.muye.core.exception.ParamException;
...
import com.muyenet.muye.service.picture.IPictureCommentService;
...
public class PictureController extends BaseController {
    ...
    public String album(Model model,@PathVariable("memberId") Integer memberId){
        ...
        return muyeConfig.getFrontTemplate() + "/picture/album";
    }
    ...
    public String indexList(Model model,@PathVariable("memberId") Integer memberId,@PathVariable("albumId") Integer albumId){
        ...
        if (pictureAlbum == null || memberId.intValue() != pictureAlbum.getMemberId().intValue()){
            return muyeConfig.getFrontTemplate() + ErrorUtil.error(model,-1010, Const.INDEX_ERROR_FTL_PATH);
        }
        if (pictureAlbum.getJuri() != 0){
            return muyeConfig.getFrontTemplate() + ErrorUtil.error(model,-1012, Const.INDEX_ERROR_FTL_PATH);
        }
        ...
        return muyeConfig.getFrontTemplate() + "/picture/list";
    }
    ...
    public Object index(Model model){
        ...
        model.addAttribute("model",responseModel);
        return muyeConfig.getFrontTemplate() + "/picture/index";
    }
    ...
    public Object detail(Model model,@PathVariable("pictureId") Integer pictureId) throws NotLoginException {
        ...
        if (picture == null){
            return muyeConfig.getFrontTemplate() + ErrorUtil.error(model,-1011, Const.INDEX_ERROR_FTL_PATH);
        }
        model.addAttribute("picture",picture);
        return muyeConfig.getFrontTemplate() + "/picture/detail";
    }
